...
public:
    ...
    void showMissedTasks() const {
        ...
        while (!missedTasks.empty()) {
            ...
            cout << index << ". \u001b[37m\u001b[1m\u001b[44mName\u001b[0m: " << task.name << ", \u001b[37m\u001b[1m\u001b[44mDescription\u001b[0m: " << task.description
                 << ",\u001b[37m \u001b[1m\u001b[44mDeadline\u001b[0m: " << task.deadline << ", \u001b[37m\u001b[1m\u001b[44mPriority\u001b[0m: " << task.priority
                 << ", \u001b[37m\u001b[1m\u001b[44mStatus\u001b[0m: " << "\u001b[1m\u001b[31mMissed\u001b[0m\u001b[0m" << endl;
            missedTasks.pop();
            ++index;
        }
    }
...
public:
    void displayTasks() const {
        ...
        while (!pqCopy.empty()) {
            Task task = pqCopy.top();
            cout << index << ". \u001b[37m\u001b[44mName\u001b[0m: " << task.name << ", \u001b[37m\u001b[44mDescription\u001b[0m: " << task.description
                 << ", \u001b[37m\u001b[1m\u001b[44mDeadline\u001b[0m: " << task.deadline << ", \u001b[37m\u001b[1m\u001b[44mPriority\u001b[0m: " << task.priority
                 << ", \u001b[37m\u001b[1m\u001b[44mStatus\u001b[0m: ";
                  if(task.status == "Done") cout<<"\u001b[1m\u001b[32mDone\u001b[0m" << endl;
                else if(task.status == "Pending") cout<<"\u001b[1m\u001b[31mPending\u001b[0m" << endl;
                 else if(task.status == "Late Done") cout<<"\u001b[1m\u001b[33mLate Done\u001b[0m" << endl;
            pqCopy.pop();
            ++index;
        }
    }
    ...
    while (true) {
        ...
        if (reminders.empty()) {
            ...
            for (const auto& task : reminders) {
                cout << " Name: " << setw(10) << task.name << "  Description: " << setw(10) << task.description <<  endl;
            }
        }
        cout << "+------------------------------------------------+" << endl;
        ...
        switch (choice) {
            ...
            case 7:
                typeText (" Exiting...\n" );
                typeText(" Thank you for using our program.");
                cout << "+------------------------------------------------+" << endl;
                return 0;
